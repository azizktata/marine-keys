...
export default function Footer({ lang }: { lang: string }) {
  ...
  return (
    <footer className="bg-[#182334] text-white py-10 px-5">
      <div className="w-[95%] max-w-7xl mx-auto flex flex-wrap items-baseline laptop:items-start  justify-between gap-8 xl:gap-8">
        {/* Logo and Socials */}
        <div>
        ...
        <div>
          ...
          <ul className=" text-sm grid grid-cols-1  sm:grid-cols-2  laptop:grid-cols-1 ml-2 mt-6 gap-x-8 gap-y-4 xl:gap-4 ">
        ...
        {/* Contact Section */}
        <div className="w-full laptop:max-w-lg xl:max-w-xl  flex flex-col">
          <h3 className="text-xl uppercase font-semibold border-l-4 border-blue-500 pl-2">
            {t("our-contact")}
          </h3>
          <div className="mt-4 flex  flex-col gap-4 md:flex-row md:gap-8 items-start">
            <iframe
            ...
            <div className="flex flex-col gap-4 font-light ">
              <div className="mt-4 text-gray-300 flex items-start gap-2">
                <MapPinIcon size={32} /> Avenue de l’environnement port de pêche
                - Tunisie
              </div>
    ...
    //         <div>
    //           <p className="font-medium text-lg text-gray-900 mb-6 sm:mb-4 text-center sm:text-left">
    //             Services
    //           </p>
    ...
    //       &copy; 2025. Maine Keys. All rights reserved.
    //     </p>
    //   </div>
    // </footer>
  );
